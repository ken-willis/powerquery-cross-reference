...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Template extension activated - ready for development!');
	...
	const disposable = vscode.commands.registerCommand('extension.helloWorld', () => {
		...
		vscode.window.showInformationMessage('Hello World from VS Code Template Extension!');
	});
	...
	const statusBarCommand = vscode.commands.registerCommand('extension.showStatus', () => {
		vscode.window.setStatusBarMessage('Template extension working!', 2000);
	});
